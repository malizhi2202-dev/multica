...
// discriminator), Feishu, WeCom, DingTalk and Tuitui all persist via the shared
...
func SurfacePersistsTranscript(channelType string) bool {
	switch channelType {
	case "", ChannelTypeFeishu, ChannelTypeWecom, ChannelTypeDingtalk, ChannelTypeTuitui:
		return true
	default:
		return false
	}
