...
export interface ListDingTalkInstallationsResponse {
  ...
  /** Whether the DingTalk integration is currently usable on this deployment.
   ...
   * configured — a bring-your-own-app install needs no hosted credentials).
   * Kept as a separate flag for forward/backward compat; optional so an older
   * desktop build that predates it treats it as off. */
